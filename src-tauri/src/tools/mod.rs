...
pub use command_manager::CommandManager as CmdManager;
...
impl ToolContext {
    ...
    pub fn browser_click(&self) -> BrowserClick { BrowserClick::new(self.app_handle.clone()) }
    pub fn browser_type(&self) -> BrowserType { BrowserType::new(self.app_handle.clone()) }
