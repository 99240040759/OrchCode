    ...
    >
      ...
      >
        ...
        <circle
          ...
          className={styles.tokenRingCircle}
        />
      </svg>
      {fraction > 0.05 && (
        <span className={styles.tokenRingLabel} style={{ color }}>
          {formattedTokens}
        </span>
      )}
    </div>
