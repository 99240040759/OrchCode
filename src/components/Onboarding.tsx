  ...
  return (
    <div className="h-full flex flex-col items-center justify-center gap-8 px-8 select-none bg-background">
      <div className="flex flex-col items-center gap-3 text-center">
        <div className="text-5xl font-bold tracking-tight bg-gradient-to-br from-foreground to-foreground bg-clip-text text-transparent">OrchCode</div>
        <p className="text-sm text-muted-foreground max-w-72">AI-powered coding agent. Sign in to get started.</p>
      </div>
      <div className="w-full max-w-72 flex flex-col gap-3">
      ...
      <p className="text-xs text-muted-foreground text-center max-w-60">Your browser will open for authentication. Return here after signing in.</p>
    </div>
  );
}
