...
// Picker filters. Images → multimodal models only. Files → every model (officeparser handles office/pdf
// natively; everything else decodes as utf8 text).
...
// Non-image attachment chip — used in the composer (removable) and message bubbles (static/clickable).
...
// Image attachment thumbnail — small + removable in the composer, larger + clickable in bubbles.
